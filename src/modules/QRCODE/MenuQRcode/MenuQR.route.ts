...
menuRouter
  .route("/")
  .post(verifyAuth, individualOnly, asyncHandler(createMenuQR));
 ...
 */
menuRouter.route("/:id").get(asyncHandler(getMenuById));
...
menuRouter
  .route("/:id")
  .put(verifyAuth, individualOnly, asyncHandler(updateMenu));
...
menuRouter
  .route("/:id")
  .delete(verifyAuth, individualOnly, asyncHandler(deleteMenu));
...
menuRouter
  .route("/analytics/:id")
  .get(verifyAuth, individualOnly, asyncHandler(getMenuAnalytics));
