...
exports.sendOtpEmail = exports.sendPasswordResetSuccessEmail = exports.sendPasswordResetEmail = exports.sendWelcomeEmail = exports.sendVerificationEmail = exports.generateMailTransporter = void 0;
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.DEPLOYED_FRONTEND_BASE_URL}/auth?view=login" class="button">Get Started Now</a>
          </div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div style="text-align: center;">
            <a href="${process.env.DEPLOYED_FRONTEND_BASE_URL}/auth?view=login" class="button">Sign In Now</a>
          </div>
          <div class="info-box">
